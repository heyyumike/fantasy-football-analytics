...
# creating data frame for transaction data
...
# all player data in the form of trades, waiver pickups, freeagent adds, etc.
...
# have one column dedicated to player team name
...
# importing in 16 files about rosters through 16 weeks
...
# importing in 16 files about scores through 16 weeks
setwd("../weekly_scores")
...
# criteria for creating best possible lineup
